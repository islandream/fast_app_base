        ...
        Stack(
          children: <Widget>[
            ...
            TextField(
              ...
              style: TextStyle(fontSize: widget.fontSize, fontWeight: widget.fontWeight, color: Colors.white70),
              decoration: InputDecoration(
                contentPadding: EdgeInsets.only(left: widget.leftImage == null ? 0 : 30, top: 10, bottom: 0),
